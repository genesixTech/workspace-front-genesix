...
const Sidebar = ({ activeStep, onStepChange }) => {
  ...
  return (
    <aside className={`fixed left-0 top-16 bottom-0 bg-white border-r border-gray-100 transition-all duration-300 z-30 ${
      collapsed ? 'w-16' : 'w-66'
    }`}>
      <div className="flex flex-col h-full">
        ...
        <div className="p-3 border-b border-gray-100">
          <div className="flex items-center justify-between">
            {!collapsed && (
              <div>
                <h2 className="text-base font-semibold text-gray-900">Fluxo do Projeto</h2>
                    ...
                    {!collapsed && (
                      <div className="flex-1 text-left">
                        <div className="flex items-center justify-between mb-0.5">
                          <h3 className="font-medium text-sm mr-2 text-gray-900">{step.title}</h3>
                          <Badge 
                            variant="outline" 
