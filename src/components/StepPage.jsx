...
const StepPage = ({ stepData, onAdvanceStep }) => {
  ...
  const [tasks, setTasks] = useState(stepData.tasks.map(task => ({ ...task, completed: false })))
  ...
  return (
    <div className="flex-1 p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button onClick={onAdvanceStep} className="bg-blue-600 text-white shadow-lg hover:bg-blue-700 h-9 px-4 text-sm">
          Avançar Tarefas
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 flex flex-col space-y-4">
            ...
            <CardContent className="flex flex-col h-[400px]">
              ...
              <div className="flex items-center space-x-2 border-t border-gray-200 pt-2">
                ...
                <Textarea
                  ...
                  rows={1}
                />
                <Button onClick={handleSendMessage} size="icon" className="bg-purple-500 hover:bg-purple-600 h-8 w-8">
          ...
          {generatedDocument && (
            <Card className="shadow-lg border-green-500">
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-green-700">Documento Gerado pela IA</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
                ...
                <div className="flex space-x-2">
                  <Button onClick={handleApproveDocument} className="bg-green-500 hover:bg-green-600 text-white h-9 px-4 text-sm">
                    <CheckCircle className="w-4 h-4 mr-2" /> Aprovar
                  </Button>
                  <Button onClick={handleEditDocument} variant="outline" className="h-9 px-4 text-sm">
                    <Edit className="w-4 h-4 mr-2" /> Editar
                  </Button>
                  <Button onClick={handleRejectDocument} variant="destructive" className="h-9 px-4 text-sm">
        ...
        <div className="lg:col-span-1 flex flex-col space-y-4">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-semibold">Checklist da Etapa</CardTitle>
            </CardHeader>
              ...
              <div className="p-2 bg-gray-50 rounded-lg border border-gray-100">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-gray-900 mb-0.5">Foco em Validação</h4>
                    <p className="text-xs text-gray-600 mb-1">A IA sugere que esta etapa se beneficie de uma validação mais aprofundada com usuários reais para garantir o alinhamento com as necessidades do mercado.</p>
                  </div>
                </div>
              </div>
              <div className="p-2 bg-gray-50 rounded-lg border border-gray-100">
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-gray-900 mb-0.5">Oportunidade de Inovação</h4>
                    <p className="text-xs text-gray-600 mb-1">Identificamos uma oportunidade de inovação ao integrar a análise de dados com feedback direto dos usuários. Considere ferramentas de pesquisa mais robustas.</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              <CardTitle className="text-lg font-semibold">Documentos da Etapa</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
              <div className="flex items-center justify-between p-2 bg-gray-50 rounded-lg border border-gray-100">
                <div className="flex items-center space-x-2">
                  <FileText className="w-4 h-4 text-gray-600" />
                  <span className="text-sm text-gray-800">Relatório de Mercado - V1.pdf</span>
                </div>
              ...
              <div className="flex items-center justify-between p-2 bg-gray-50 rounded-lg border border-gray-100">
                <div className="flex items-center space-x-2">
                  <FileText className="w-4 h-4 text-gray-600" />
                  <span className="text-sm text-gray-800">Análise Competitiva - V2.docx</span>
                </div>
                <Button variant="ghost" size="sm" className="h-7 px-2 text-xs">Ver</Button>
              </div>
            </CardContent>
